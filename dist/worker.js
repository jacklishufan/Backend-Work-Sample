...
exports.reactPost = exports.commentPost = exports.makeposts = exports.getposts = exports.helloworld = void 0;
const postProvider_1 = __importDefault(__webpack_require__(/*! ./postProvider */ "./src/postProvider.ts"));
const provider = new postProvider_1.default();
...
router
    .get('/posts', api_1.getposts)
    .post('/posts', api_1.makeposts)
    .post('/comments', api_1.commentPost)
    .post('/react', api_1.reactPost)
